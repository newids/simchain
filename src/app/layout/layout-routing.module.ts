...
const routes: Routes = [
    {
        ...
        children: [
          ...
          { path: 'pop-block', loadChildren: './pop-block/pop-block.module#PopBlockModule' },
          { path: 'pop-user', loadChildren: './pop-user/pop-user.module#PopUserModule' },
          { path: 'pop-wallet', loadChildren: './pop-wallet/pop-wallet.module#PopWalletModule' },
        ]
    }
];
